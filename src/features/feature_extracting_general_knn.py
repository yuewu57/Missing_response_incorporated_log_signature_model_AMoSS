...
if __name__ == '__main__':
    ...
    for data_cat in data_cats[1:]: 
        ...
        data_weekly=load_pickle(DATA_interim+"participants_class_"+data_cat+"_general_knn.pkl")
            ...
            for time in [False, True][:1]:
                ...
                for count in [False, True][:1]:
                    ...
                    for normalise in [False, True][:1]:
                        ...
                        subdir=data_cat+'/'+name_reg[int(regression)]+'/'+str(minlen)+'/many_per_par_general_knn/'
